...
const Register = () => {
  ...
  const checkConfirm = (_, value) => {
    ...
    if (value && value !== form.getFieldValue('password')) {
      return promise.reject('password must be the same');
    }
      ...
      <Form form={form} name="UserRegister" onFinish={onFinish}>
        <FormItem
          ...
          rules={[
            ...
            {
              type: 'email',
              message: 'incorrecr email address format!',
            },
          ]}
        >
          ...
          content={
            visible && (
              ...
              >
                ...
                >
                  <span>password need to have 6 or more characters</span>
                </div>
              </div>
            )
          }
        ...
        <InputGroup compact>
          ...
          <FormItem
            ...
            rules={[
              ...
              {
                pattern: /^\d{11}$/,
                message: 'incorrecr phone number format',
              },
            ]}
          >
        ...
        <Row gutter={8}>
          <Col span={16}>
            <FormItem
              ...
              rules={[
                {
                  required: true,
                  message: 'please enter verification coe',
                },
              ]}
            >
          ...
          <Col span={8}>
            ...
            >
              {count ? `${count} s` : 'recieve verification code'}
            </Button>
          </Col>
        </Row>
        <FormItem>
