...
import constructor_logo from './client_logo_2.png';
...
function HeaderBlock({blockType, index, project, editing, ctrlNumVisible, setCtrlNumVisible, moveHeaderBlock}: props) {
    /*********dnd stuff******** */
  ...
  const visibleHandler = () => {
    setCtrlNumVisible(!ctrlNumVisible)
  }
    ...
    case "proj_info":
        return (
            ...
            >
                ...
                >
                <p><Input placeholder={project?'Contract No.: '+project.project_code:'Contract No.'} disabled style={{textAlign:'center'}}/></p>
                <p><TextArea
