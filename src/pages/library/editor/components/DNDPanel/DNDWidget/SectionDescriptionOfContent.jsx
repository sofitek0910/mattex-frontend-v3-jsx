...
const SectionDescriptionOfContent = ({
  ...
  //cancel sorting if focusing on InputComponent's inputbox
  ...
  //use updateBeforeSortStart to change data (work as the same as InputComponent's onBlur listener) before sorting instead?
            ...
            <div style={{ display: 'flex', justifyContent: 'center', padding: '4px' }}>
              <Space>
                ...
                <Button
                  ...
                  type="primary"
                  icon={<CopyOutlined />}
                  onClick={() => { setSpecSetImportPopupShow(true) }}
                  disabled={!editing}
                  style={{ borderRadius: '25px' }}
                >
