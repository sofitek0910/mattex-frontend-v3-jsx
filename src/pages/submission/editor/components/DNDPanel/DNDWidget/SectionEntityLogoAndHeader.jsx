...
const EntityLogoAndHeader = ({
  ...
  const [constructor_logoVisible, setConstructor_logoVisible] = useState(
    data.constructor_logoVisible,
  );
  ...
  const SortableList = sortableContainer(({ children }) => {
    ...
    return (
      ...
      // >
      <ul style={{ display: 'inline' }}>{children}</ul>
      //</Col>
      //<span>{children}</span>
    );
  });
